...
public class JasperCSVdata {
	...
	return acp.substring(0,p);
     ...
     private static MediaTray getTray(String trayname){
          ...
          */
         Map<String,MediaTray> tray=new HashMap<>();
         tray.put("MediaTray.BOTTOM", MediaTray.BOTTOM);
         tray.put("MediaTray.ENVELOPE", MediaTray.ENVELOPE);
         tray.put("MediaTray.LARGE_CAPACITY", MediaTray.LARGE_CAPACITY);
         tray.put("MediaTray.MAIN", MediaTray.MAIN);
         tray.put("MediaTray.MANUAL", MediaTray.MANUAL);
         tray.put("MediaTray.MIDDLE", MediaTray.MIDDLE);
         tray.put("MediaTray.SIDE", MediaTray.SIDE);
         tray.put("MediaTray.TOP", MediaTray.TOP);
         
        return tray.get(trayname);
     }
